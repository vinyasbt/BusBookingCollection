...
public class App {
	...
	public static void main(String[] args) {
		...
		while (state) {
			...
			int firstChoice = Integer.parseInt(service.checkUserIdAndBookinIdAndBusId((input.next())));
			if (firstChoice == 1) {
				boolean check = true;
				System.out.println("Enter UserId");
				while (check) {
					String uid = service.checkUserIdAndBookinIdAndBusId((input.next()));
					if (uid != null) {
				...
				while (login) {
					...
					System.out.println("********************************************");
					System.out.print("ENTER CHOICE :");
					int choice = Integer.parseInt(service.checkUserIdAndBookinIdAndBusId((input.next())));
					if (choice == 1) {
						...
						try {
							...
							ticket.setSource(input.next());
							System.out.println("Enter Destination");
							ticket.setDestination(input.next());
							System.out.println("Enter Date iN YYYY-MM-DD FORMAT");
							ticket.setDate(service.checkDate(input.next()));
			...
			} else if (firstChoice == 2) {//create account
				User user4 = new User();
				...
				if (user != null) {
					...
					String email = service.checkEmail(input.next());
					if (email != null) {
					...
					if (user != null) {
						...
						System.out.println("Enter Password");
						user4.setPassword(input.next());
						System.out.println("Enter Contact number");
						check = true;
						while (check) {
							String uid = service.checkContact(input.next());
							if (uid != null) {
			...
			} else if (firstChoice == 3) {//admin login
				System.out.println("Enter Admin Id");
				Boolean check = true;
				while (check) {
					String uid = adminService.checkUserIdAndBookinIdAndBusId((input.next()));
					if (uid != null) {
				...
				while (adminLogin) {
					...
					if (adminChoice == 1) {
						...
						if (bus != null) {
							...
							bus2.setBusName(input.next());
							System.out.println("bus Type");
							bus2.setBusType(input.next());
							System.out.println("Source");
							bus2.setSource(input.next());
							System.out.println("Destination");
							bus2.setDestination(input.next());
							...
							if (create) {
								...
								available.setJourneyDate(input.next());
						...
						if (bus != null) {
							System.out.println("Enter Bus Name");
							bus.setBusName(input.next());
							System.out.println("Bus Type");
							bus.setBusType(input.next());
							System.out.println("Enter Source");
							bus.setSource(input.next());
							System.out.println("Enter Destination");
							bus.setDestination(input.next());
							System.out.println("Price");
							check = true;
							while (check) {
								String uid = service.checkUserIdAndBookinIdAndBusId((input.next()));
